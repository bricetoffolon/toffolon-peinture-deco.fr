...
import { Box, Button, Flex, Heading, Image, Stack, Text, VStack, keyframes, Wrap } from '@chakra-ui/react';
...
const mobileImages = [
    "https://example.com/mobile-image1.jpg",
    "https://example.com/mobile-image2.jpg",
  ];
  const tabletImages = [
  ...
  const desktopImages = [
    ...
    "https://example.com/desktop-image2.jpg",
  ];
  ...
  return (
    <>
      <Head>
        <title>Entreprise de Bâtiment - Expertise en Ravalement, Isolation et Peinture</title>
        <meta
          name="description"
        ...
        />
        <meta name="keywords" content="Ravalement, Isolation Thermique, Revêtement de sol, Peinture, Bâtiment, Expertise" />
    ...
    <Box as="main" bg="brand.500" color="white" overflow="hidden" position="relative">
      ...
      >
        <VStack spacing={4}>
          ...
          />
          <Text fontWeight="bold" fontSize={{ base: "md", lg: "lg" }}textAlign="center" maxWidth="600px">
            Spécialistes en ravalement de façades, isolation thermique, revêtements de sol et peinture.
            La qualité et le professionnalisme à votre service depuis 1960
          </Text>
        ...
        <Wrap justify="center" spacing={8}>
            {[
              ...
              },
              {
                ...
                description: 'Des sols résistants et élégants adaptés à tous vos besoins.',
                href: '/revetement-sols',
              },
              {
                title: 'Peinture',
                description: 'Apportez une touche de couleur et de modernité à vos espaces.',
                href: '/peinture',
              },
            ].map((service, index) => (
              <Flex
