...
import { Box, Heading, Image, Text, VStack, Stack, Flex } from "@chakra-ui/react";
      ...
      <Box as="main" bg="brand.500" color="white" py={8}>
        ...
        <Box textAlign="center" py={12}>
          ...
          <Text fontSize="lg" maxWidth="800px" mx="auto">
            Découvrez l'histoire et les valeurs de la SAS TOFFOLON, une entreprise familiale fondée en 1960, dédiée à fournir des services de qualité dans le domaine de la peinture, de la décoration, et du ravalement.
          </Text>
        </Box>
        ...
        <Box bg="white" color="brand.900" py={12} px={6}>
          <Stack direction={{ base: "column", lg: "row" }} spacing={8} align="center">
            <Box flex="1">
              <Image
                src="https://toffolon-website.s3.eu-west-3.amazonaws.com/about/pavillon-le-raincy-apres.jpeg"
            ...
            <Box flex="2">
              ...
              <Text fontSize="md" mb={4}>
                Issue d'une entreprise familiale créée en 1960, la SAS TOFFOLON est aujourd'hui dirigée par
                Jean-Marc Toffolon depuis 1991. Forts de décennies d'expérience, nous mettons notre expertise
                au service des professionnels et des particuliers, en Île-de-France et même en province pour les professionnels.
              </Text>
              <Text fontSize="md">
                Notre savoir-faire se reflète dans nos conseils techniques et dans notre capacité à gérer l'intégralité
                de vos chantiers, de la planification à l'exécution, avec une équipe dédiée et qualifiée.
              </Text>
            </Box>
          </Stack>
        </Box>
        ...
        <Box bg="brand.400" color="white" py={12} px={6}>
          <Stack direction={{ base: "column", lg: "row-reverse" }} spacing={8} align="center">
            <Box flex="1">
              <Image
                src="/images/jean-marc-toffolon.jpg"
            ...
            <Box flex="2">
              ...
              <Heading fontStyle="italic" fontSize="md" mb={4}>
                “Respecter les attentes de nos clients en tenant compte des contraintes techniques, c’est la base de notre métier…”
                – Jean-Marc Toffolon
              </Heading>
              <Text fontSize="md" mb={4}>
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "1rem" }}>
                ...
                <li>Des matériaux de qualité provenant de grandes marques telles que STO, Seigneurie, Tollens, et bien d'autres.</li>
              </ul>
            </Box>
          </Stack>
        </Box>
        ...
        <Box bg="white" color="brand.900" py={12} px={6}>
          ...
          <Flex justify="center" alignItems="center" flexWrap="wrap" gap={"7%"} direction={{base: "column", lg: "row"}}>
            <Flex direction="column" alignItems="center" gap={3} maxW={"5%"}>
                <Image
                  ...
                  minW="90px"
                />
                <Heading textAlign="center" size="md" maxW={{ base: '90vw', xl: '25vw' }}>
